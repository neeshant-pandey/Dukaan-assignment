const footer = () => {
  return (
    <section className="available-credits">
      <aside className="credits-icon">
        {
          <svg
            width="24"
            height="24"
      ...
      <aside className="credits-info">
        <p className="credits-text">Available credits</p>
        <b className="credits-amount">222.10</b>
      </aside>
    </section>
  );
};
